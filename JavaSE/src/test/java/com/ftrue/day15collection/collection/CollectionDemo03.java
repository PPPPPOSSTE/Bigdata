 ...
 * @Description:
 * @Author: zhiqi zhang on 2021/7/16 11:38
 * @Version: 1.0
 */
...
public class CollectionDemo03 {
    public static void main(String[] args) {
        ...
        //运行时异常：ConcurrentModificationException
        //使用迭代器遍历集合中的元素时，在遍历的过程中不能针对集合的元素的个数有任何操作，否则会发生运行时异常ConcurrentModificationException
        //coll.add(123);
