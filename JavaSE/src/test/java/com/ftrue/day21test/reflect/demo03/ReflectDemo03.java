package com.ftrue.day21test.reflect.demo03;

/**
 * @ClassName: ReflectDemo03
 * @Description:
 * @Author: zhiqi zhang on 2021/7/23 16:26
 * @Version: 1.0
 */
/**
...
public class ReflectDemo03 {
    public static void main(String[] args) {
        System.out.println(ReflectDemo03.class.getClassLoader());  //sun.misc.Launcher$AppClassLoader@18b4aac2
