 ...
 * @Description:
 * @Author: zhiqi zhang on 2021/7/19 14:36
 * @Version: 1.0
 */
/**
...
public class FileDemo01 {
    public static void main(String[] args) {
        //创建File类对象
        File f1 = new File("E:\\abc\\a"); //真实存在的文件夹
        File f2 = new File("E:\\abc\\a.txt"); //真实存在的文件
        File f3 = new File("E:\\abc\\b"); //不存在的文件夹
        ...
        //获取文件的大小
        System.out.println(f2.length());  //748
        System.out.println(f1.length());  //0  为目录时长度为0
