package com.ftrue.day13test.exception.demo09;
...
public class ExceptionDemo09 {
    ...
    public static int method5() {
        ...
        try {
            ...
            return a;  //此时return 10的时候发现有finally语句，先执行finally语句，虽然针对a进行改变，但是return的值已经确定
        } catch (Exception e) {
    ...
    public static int method3() {
        try {
            ...
            return 10;  //此时准备执行return 10的时候，发现try后面有finally，先执行finally语句，再执行return 10
        } catch (Exception e) {
            System.out.println("catch");
            return 20;
        } finally {
